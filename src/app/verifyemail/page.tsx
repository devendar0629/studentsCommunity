    ...
    return (
        <>
            <main className="h-screen flex flex-col flex-nowrap justify-center items-center">
                <Card
                    className={`lg:h-[55%] lg:w-[60%] w-[80%] border-[#ccc] flex flex-col gap-8 justify-start items-center lg:pt-16 py-14 ${poppins.className}`}
                >
                    {status == "PENDING" && (
                        ...
                        <div>
                            {status === "NOT-STARTED" && (
                                <>
                                    <Button
                                        onClick={verifyEmail}
                                        className="mt-6 lg:text-[1.05rem] px-5 py-2"
                                        variant={"secondary"}
                                    >
                                        Verify
                                    </Button>
